...
function Theory({setTheoryRef}){
    ...
    return <div className="theory" ref={my_theory}>
        ...
        <div className="theory_intro">From a theoretical point of view, the Maestro application 
            is based on the foundations presented in <a href="https://dl.acm.org/doi/10.1145/3319535.3354193" className="theory_intro_link">research-article</a>
        , co-authored by Saša Radomiroviÿ.</div>
