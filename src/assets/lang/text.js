const text = {
    ...
    dictionary: [
        ...
        {
            term: {
                EN: "Account Ecosystem Manager",
                FR: "Gestionnaire d'écosystème de comptes ",
    ...
    maestroPlus: {
        ...
        disWar: {
            ...
            FR: "Affichage des avertissements",
        ...
        manmod: {
            ...
            FR: "Profils d'attaquant en mode manuel",
            GEO: "შემტევი პროფილი მექანიკური რეჟიმი"
        },
        autmode: {
            EN: "Attacker profile in automatic mode",
        ...
        team: [
            {
                ...
                linkedIn: "https://www.linkedin.com/in/luka-rakviashvili/",
            },
        ],    
        subtext: {
            EN: "",
